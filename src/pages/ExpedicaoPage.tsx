      ...
      <div className="glass-card rounded-2xl overflow-hidden" style={{ borderColor: "hsl(270 100% 50% / 0.2)" }}>
        <div className="flex flex-row items-center justify-between gap-4 flex-wrap p-5 border-b border-border/30">
          <div className="flex items-center gap-2">
            ...
            <h2 className="font-orbitron text-sm font-bold text-[hsl(var(--neon-purple))] uppercase">VISUALIZAÇÃO DO PÁTIO</h2>
          </div>
          ...
          <Table>
            <TableHeader>
              <TableRow className="border-border/30 hover:bg-transparent">
                <TableHead className="font-orbitron text-[0.65rem] text-[hsl(var(--neon-purple))] uppercase font-bold">PLACA</TableHead>
